...
export default function Login () {
  ...
  return (
      <form action='/login' className="shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit} >
      ...
      <input className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline cursor-pointer" type="submit" value="Iniciar sesión" />
      </form>
  )
}
